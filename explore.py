...
data=pd.read_csv(r"C:\Users\tejaj\OneDrive\Desktop\email_spam_predictor\files\emails.csv")
...
joblib.dump(gnb, 'spamemail.joblib')
joblib.dump(featurenames, 'spammail_features.joblib')
joblib.dump(cv, 'converter.joblib')
